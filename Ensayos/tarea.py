...
def get_all_students():
  """Imprime en consola la lista de estudiantes."""
...
def get_student_by_id(id): # snake_case
  """Imprime en consola los datos de un estudiante dado su id."""
  for student in students:
    if student["id"]==id:
...
def delete_student_by_id(id):
  """Elimina un estudiante de la lista, dado su id."""
  for student in students:
    if student["id"] == id:
...
def age_student(id):
  """Calcula la edad de un estudiante dado su id."""
  for student in students:
    if student["id"] == id:
...
def ad_notes(id): # docstring:
  """Agrega una nota a la lista de notas de un estudiante dado su id."""
  for student in students:
    if student["id"] == id:
...
def students_average(id: int) -> float:
  """Calcula el promedio de las notas de un estudiante dado su id."""
  for student in students:
    if student["id"] == id:
      grades = student['grades']
      av = float(sum(grades)/len(grades))
  return av
            

def students_aprob():
  """Devuelve True si un estudiante aprueba o False si reprueba (La nota mínima aprobatoria es 3)"""
  aprobados = []
  desaprobados = []
  for student in students:
    average = students_average(student["id"])
    if average >= 3.0:
      aprobados.append(student)
    else:
      desaprobados.append(student)
